...
<body>
    ...
    <?php
    $query_sql = "SELECT Htl.Hnome as Nome_Hotel, Rsv.CNPJ as CNPJ_Hotel, TRUNCATE (Sum(Rsv.Custo_total), 2) as Receita_Total
    ...
    if($sql->rowCount() != 0){  //se tiver achado alguma reserva para contar
        ...
        <center>
        <div>
            <center><h1>Relatório Receita dos Hoteis</h1><br></center>
        ...
        while($row = $sql->fetch(PDO::FETCH_ASSOC)) {
            ...
            <tr>
                ...
                <td><center><?php echo $row["Receita_Total"]; ?></center></td>
            </tr>
